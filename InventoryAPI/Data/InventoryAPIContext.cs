    ...
    public class InventoryAPIContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
			...
			modelBuilder.Entity<Orders>().HasData(
			   new Orders { Id = orderId1, OrderDate = DateOnly.Parse("2024-10-12"), ProductId = productId1, Quantity = 35, OrderType = "Out" },
			   new Orders { Id = orderId2, OrderDate = DateOnly.Parse("2024-10-25"), ProductId = productId4, Quantity = 50, OrderType = "In" }
